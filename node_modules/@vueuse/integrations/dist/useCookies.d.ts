...
declare function createCookies(req?: IncomingMessage): (dependencies?: string[] | null, { doNotParse, autoUpdateDependencies }?: {
   ...
   */
  get: <T = any>(name: string, options?: import("universal-cookie").CookieGetOptions | undefined) => T;
  /**
   * Reactive get all cookies
   */
  getAll: <T = any>(options?: import("universal-cookie").CookieGetOptions | undefined) => T;
  set: (name: string, value: any, options?: import("universal-cookie").CookieSetOptions | undefined) => void;
  remove: (name: string, options?: import("universal-cookie").CookieSetOptions | undefined) => void;
  addChangeListener: (callback: import("universal-cookie").CookieChangeListener) => void;
  removeChangeListener: (callback: import("universal-cookie").CookieChangeListener) => void;
};
/**
