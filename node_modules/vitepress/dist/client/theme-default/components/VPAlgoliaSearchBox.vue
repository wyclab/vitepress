...
import { buildSidePanelProps, resolveMode, validateCredentials } from "../support/docsearch";
...
async function initialize(userOptions) {
	...
	const options = {
		...
		...useSidePanel && sidepanelInstance && { interceptAskAiEvent: (initialMessage) => {
