...
import { computedAsync, watchDebounced, onKeyStroke, useEventListener, useLocalStorage, useSessionStorage } from "@vueuse/core";
import { useFocusTrap } from "@vueuse/integrations/useFocusTrap";
import Mark from "mark.js/src/vanilla.js";
import MiniSearch from "minisearch";
import { dataSymbol, useRouter, withBase } from "vitepress";
import { computed, createApp, markRaw, nextTick, onBeforeUnmount, onMounted, ref, shallowRef, useTemplateRef, watch, watchEffect } from "vue";
...
const searchIndex = computedAsync(async () => {
	...
	if (!json) return null;
	return markRaw(MiniSearch.loadJSON(json, {
		fields: [
			"title",
			"titles",
			"text"
